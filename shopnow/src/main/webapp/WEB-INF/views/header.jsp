...
<header class="header_area">
	<div
		...
		<!-- Classy Menu -->
		<nav class="classy-navbar" id="shopnowNav">
			<!-- Logo -->
			<a class="nav-brand" href="/"><h6>SHOPNOW</h6></a>
			<!-- Navbar Toggler -->
					...
					<ul>
						<li><a href="#">Shop</a>
							<div class="megamenu">
								...
								<ul class="single-mega cn-col-4">
									<li class="title">Girl's Collection</li>
									<li><a href="/shop">Dresses</a></li>
									<li><a href="/shop">Shirts</a></li>
									<li><a href="/shop">T-shirts</a></li>
									<li><a href="/shop">Jackets</a></li>
								...
								<ul class="single-mega cn-col-4">
									<li class="title">Boy's Collection</li>
									<li><a href="/shop">Dresses</a></li>
									<li><a href="/shop">Shirts</a></li>
									<li><a href="/shop">T-shirts</a></li>
									<li><a href="/shop">Jackets</a></li>
		...
		<div class="header-meta d-flex clearfix justify-content-end">
			...
			<!-- Cart Area -->
			<div class="cart-area">
				<a href="#" id="shopnowCartBtn"><img src="img/core-img/bag.svg"
					alt=""> <span>3</span></a>
			</div>
		</div>
	...
	<div class="cart-content d-flex">
		...
		<div class="cart-amount-summary">
			...
			<div class="checkout-btn mt-100">
				<a href="/checkout" class="btn shopnow-btn">check out</a>
			</div>
		</div>
	</div>
</div>
